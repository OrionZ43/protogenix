  ...
  Future<void> _doLoad(TrackModel track, Object token) async {
    ...
    try {
      ...
      if (content == null || content.trim().isEmpty) {
        ...
        _cache[track.id] = const ParsedLyrics(
          lines: [],
...
final karaokeProvider = StateNotifierProvider<KaraokeNotifier, KaraokeState>((
  ref,
) {
...
final hasSyllableTimingsProvider = karaokeProvider.select(
  (s) => s.hasSyllableTimings,
);
